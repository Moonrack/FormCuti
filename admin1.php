        ...
        <div id="content" class="p-4 p-md-5 pt-5">
          <div class="container">
            <div class="row">
              ...
              <p class="col md-15" style="margin-top: 16rem;">
              ...
              <div class="col mt-5">
                <div class="card">
                  <h5 class="card-header text-center">Penerimaan Cuti</h5>
                  <div class="card-body">
                    <h5 class="card-title text-center">Informasi Pengajuan Cuti</h5>
                    <a href="admin.php" style="margin-left: 4rem;" class="button button1">Lihat Cuti</a>
                  </div>
                </div>
              </div>
              <div class="col mt-5">
                <div class="card" style="background-color: #5D3FD3;">
                  <h5 class="card-header text-center">Penerimaan Izin</h5>
                  <div class="card-body">
                    <h5 class="card-title text-center">Informasi Pengajuan Izin</h5>
                    <a href="admin_izin.php" style="margin-left:4rem;" class="button button1">Lihat Izin</a>
                  </div>
                </div>
              </div>
              <div class="col mt-5">
                <div class="card" style="background-color: #D27D2D;">
                  <h5 class="card-header text-center">Karyawan</h5>
                  <div class="card-body">
                    <h5 class="card-title text-center">Data Karyawan</h5>
                    <a href="#" style="margin-left: 4rem;" class="button button1">Edit Data</a>
                  </div>
                </div>
              </div>
              <div class="col mt-5">
                <div class="card" style="background-color: #7393B3;">
                  <h5 class="card-header text-center">Laporan</h5>
                  <div class="card-body">
                    <h5 class="card-title text-center">Rekap Laporan Data</h5>
                    <a href="#" style="margin-left:3rem;" class="button button1">Lihat Laporan</a>
                  </div>
                </div>
              </div>
            </div>
